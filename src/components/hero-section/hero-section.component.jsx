...
import MyImage from '../../assets/MyPhotoPNG.png';
//animations
    ...
    return (
        ...
        <div className='hero-section'>
            ...
            <div className='hero-image-container'>
                <motion.img className='hero-image' src={MyImage} alt='Tomasz Posiadala - website owner and creator' variants={heroImageAnimations} initial="hidden" animate="show"/>
            </div>
        </div>
